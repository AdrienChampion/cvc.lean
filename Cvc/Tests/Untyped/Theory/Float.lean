...
import Cvc.Untyped.Theory.Float
import Cvc.Untyped.Core.Bool
import Cvc.Untyped.Theory.BitVec
import Cvc.Types.Float

public meta import Cvc.Untyped.Theory.Float
public meta import Cvc.Untyped.Core.Bool
public meta import Cvc.Untyped.Theory.BitVec
public meta import Cvc.Types.Float



/-! # Generated Float constructors, sort-erased -/
namespace Cvc.Tests.Untyped.Term.Float
...
#guard_msgs in #eval Env.runIO do
  let f ← Cvc.Untyped.Term.mkSymbolAs (Cvc.Float 8 24) "f"
  let g ← Cvc.Untyped.Term.mkSymbolAs (Cvc.Float 8 24) "g"
...
#guard_msgs in #eval Env.runIO do
  let f ← Cvc.Untyped.Term.mkSymbolAs (Cvc.Float 8 24) "f"
  let g ← Cvc.Untyped.Term.mkSymbolAs (Cvc.Float 8 24) "g"
  let rm ← Cvc.Untyped.Term.mkRoundingMode .nearestTiesToEven
  let sgn ← Cvc.Untyped.Term.mkSymbolAs (BitVec 1) "sgn"
  let ex ← Cvc.Untyped.Term.mkSymbolAs (BitVec 8) "ex"
  let sig ← Cvc.Untyped.Term.mkSymbolAs (BitVec 23) "sig"
...
#guard_msgs in #eval Env.runIO do
  ...
  let rm ← Cvc.Untyped.Term.mkRoundingMode .nearestTiesToEven
  let w ← Cvc.Untyped.Term.mkSymbolAs (BitVec 32) "w"
