...
import Cvc.Proto.Typed.Term.Float
import Cvc.Proto.Typed.Term.Bool
import Cvc.Proto.Typed.Term.BitVec

public meta import Cvc.Proto.Typed.Term.Float
public meta import Cvc.Proto.Typed.Term.Bool
public meta import Cvc.Proto.Typed.Term.BitVec



/-! # Generated Float constructors, typed -/
namespace Cvc.Proto.Tests.Typed.Term.Float
...
#guard_msgs in #eval Env.runIO do
  let f ← Cvc.Proto.Typed.Term.mkSymbolAs (Cvc.Proto.Float 8 24) "f"
  let g ← Cvc.Proto.Typed.Term.mkSymbolAs (Cvc.Proto.Float 8 24) "g"
...
#guard_msgs in #eval Env.runIO do
  let f ← Cvc.Proto.Typed.Term.mkSymbolAs (Cvc.Proto.Float 8 24) "f"
  let g ← Cvc.Proto.Typed.Term.mkSymbolAs (Cvc.Proto.Float 8 24) "g"
  let rm ← Cvc.Proto.Typed.Term.mkRoundingMode .nearestTiesToEven
  let sgn ← Cvc.Proto.Typed.Term.mkSymbolAs (BitVec 1) "sgn"
  let ex ← Cvc.Proto.Typed.Term.mkSymbolAs (BitVec 8) "ex"
  let sig ← Cvc.Proto.Typed.Term.mkSymbolAs (BitVec 23) "sig"
...
#guard_msgs in #eval Env.runIO do
  ...
  let rm ← Cvc.Proto.Typed.Term.mkRoundingMode .nearestTiesToEven
  let w ← Cvc.Proto.Typed.Term.mkSymbolAs (BitVec 32) "w"
  let u ← Cvc.Proto.Typed.Term.mkSymbolAs (BitVec 4) "u"
