...
namespace Cvc.Proto.Tests.Typed.Term.BitVec
...
#guard_msgs in #eval Env.runIO do
  ...
  let v ← Cvc.Proto.Typed.Term.mkSymbolAs (BitVec 4) "v"
  let w ← Cvc.Proto.Typed.Term.mkSymbolAs (BitVec 6) "w"
...
#guard_msgs in #eval Env.runIO do
  let u ← Cvc.Proto.Typed.Term.mkSymbolAs (BitVec 4) "u"
  let v ← Cvc.Proto.Typed.Term.mkSymbolAs (BitVec 4) "v"
  let c ← Cvc.Proto.Typed.Term.mkSymbolAs (BitVec 1) "c"
...
-/
#guard_msgs in #eval Env.runIO do
  let u ← Cvc.Proto.Typed.Term.mkSymbolAs (BitVec 8) "u"
...
#guard_msgs in #eval Env.runIO do
  ...
  let c ← Cvc.Proto.Typed.Term.mkSymbolAs Bool "c"
