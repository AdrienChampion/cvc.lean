...
import Cvc.Proto.Typed.Term.Seq
import Cvc.Proto.Typed.Term.Bool

public meta import Cvc.Proto.Typed.Term.Seq
public meta import Cvc.Proto.Typed.Term.Bool



/-! # Generated Seq constructors, typed -/
namespace Cvc.Proto.Tests.Typed.Term.Seq
...
#guard_msgs in #eval Env.runIO do
  println! "mkEmptySeq : {← (mkEmptySeq : Env (Cvc.Proto.Typed.Term (Array Int)))}"
