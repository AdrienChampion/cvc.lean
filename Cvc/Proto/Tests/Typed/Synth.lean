...
import Cvc.Proto.Typed.Synth
import Cvc.Proto.Typed.Term

public meta import Cvc.Proto.Typed.Synth
public meta import Cvc.Proto.Typed.Term



/-! # Syntax-guided synthesis, typed -/
namespace Cvc.Proto.Tests.Typed.Synth
...
#guard_msgs in #check @Cvc.Proto.Typed.Solver.synthFun

/-- info: @Solver.getSynthSolution : [inst : Ω] → Solver → {σ : Type} → Term σ → EnvSolved (Term σ) -/
#guard_msgs in #check @Cvc.Proto.Typed.Solver.getSynthSolution
...
#guard_msgs in #check @Cvc.Proto.Typed.Solver.addSygusConstraint
