...
-/
namespace Cvc.Proto.Tests.Signatures
...
#guard_msgs in #check @Cvc.Proto.Typed.Term.equal
...
#guard_msgs in #check @Cvc.Proto.Typed.Term.equalN
...
#guard_msgs in #check @Cvc.Proto.Typed.Term.add

/-- info: @Typed.Term.neg : [inst : Ω] → {α : Type} → [inst_1 : ToTyp α] → [IsArith α] → Typed.Term α → Env (Typed.Term α) -/
#guard_msgs in #check @Cvc.Proto.Typed.Term.neg
...
#guard_msgs in #check @Cvc.Proto.Typed.Term.bvConcat

/-- info: @Typed.Term.bvUlt : [inst : Ω] → {n : Nat} → Typed.Term (BitVec n) → Typed.Term (BitVec n) → Env (Typed.Term Bool) -/
#guard_msgs in #check @Cvc.Proto.Typed.Term.bvUlt
...
#guard_msgs in #check @Cvc.Proto.Typed.Term.select
...
#guard_msgs in #check @Cvc.Proto.Typed.Term.setMember
...
#guard_msgs in #check @Cvc.Proto.Typed.Term.seqNth
...
#guard_msgs in #check @Cvc.Proto.Typed.Term.fpIsNan
...
#guard_msgs in #check @Cvc.Proto.Typed.Term.bvIte
...
#guard_msgs in #check @Cvc.Proto.Typed.Term.bagPartition
...
#guard_msgs in #check @Cvc.Proto.Typed.Term.bvFromBool
...
#guard_msgs in #check @Cvc.Proto.Typed.Term.bvFromBools
...
: Env (Term (Cvc.Proto.Float 8 24)) := fpOfBits sgn ex sig
