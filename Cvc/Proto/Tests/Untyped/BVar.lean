...
import Cvc.Proto.Untyped.BVar
import Cvc.Proto.Untyped.Term
import Cvc.Proto.Untyped.Solver

public meta import Cvc.Proto.Untyped.BVar
...
-/
namespace Cvc.Proto.Tests.Untyped.BVar
...
#guard_msgs in #eval Env.runIO do
  ...
  println! "BVar.mk: {(← Cvc.Proto.Untyped.BVar.mk int "w").toTerm}"
...
#guard_msgs in #check @Cvc.Proto.Untyped.Term.mkBVar
