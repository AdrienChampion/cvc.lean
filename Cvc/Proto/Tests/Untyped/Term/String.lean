...
import Cvc.Proto.Untyped.Term.String
import Cvc.Proto.Untyped.Term.Bool

public meta import Cvc.Proto.Untyped.Term.String
public meta import Cvc.Proto.Untyped.Term.Bool



/-! # Generated String constructors, sort-erased -/
namespace Cvc.Proto.Tests.Untyped.Term.String
...
#guard_msgs in #eval Env.runIO do
  let s ← Cvc.Proto.Untyped.Term.mkSymbolAs (String) "s"
  let t ← Cvc.Proto.Untyped.Term.mkSymbolAs (String) "t"
  let re ← Cvc.Proto.Untyped.Term.mkSymbolAs (Cvc.Proto.Regex) "re"
