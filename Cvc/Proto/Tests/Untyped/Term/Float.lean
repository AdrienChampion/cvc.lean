...
import Cvc.Proto.Untyped.Term.Float
import Cvc.Proto.Untyped.Term.Bool
import Cvc.Proto.Untyped.Term.BitVec
import Cvc.Proto.Types.Float

public meta import Cvc.Proto.Untyped.Term.Float
public meta import Cvc.Proto.Untyped.Term.Bool
public meta import Cvc.Proto.Untyped.Term.BitVec
public meta import Cvc.Proto.Types.Float



/-! # Generated Float constructors, sort-erased -/
namespace Cvc.Proto.Tests.Untyped.Term.Float
...
#guard_msgs in #eval Env.runIO do
  let f ← Cvc.Proto.Untyped.Term.mkSymbolAs (Cvc.Proto.Float 8 24) "f"
  let g ← Cvc.Proto.Untyped.Term.mkSymbolAs (Cvc.Proto.Float 8 24) "g"
...
#guard_msgs in #eval Env.runIO do
  let f ← Cvc.Proto.Untyped.Term.mkSymbolAs (Cvc.Proto.Float 8 24) "f"
  let g ← Cvc.Proto.Untyped.Term.mkSymbolAs (Cvc.Proto.Float 8 24) "g"
  let rm ← Cvc.Proto.Untyped.Term.mkRoundingMode .nearestTiesToEven
  let sgn ← Cvc.Proto.Untyped.Term.mkSymbolAs (BitVec 1) "sgn"
  let ex ← Cvc.Proto.Untyped.Term.mkSymbolAs (BitVec 8) "ex"
  let sig ← Cvc.Proto.Untyped.Term.mkSymbolAs (BitVec 23) "sig"
...
#guard_msgs in #eval Env.runIO do
  ...
  let rm ← Cvc.Proto.Untyped.Term.mkRoundingMode .nearestTiesToEven
  let w ← Cvc.Proto.Untyped.Term.mkSymbolAs (BitVec 32) "w"
