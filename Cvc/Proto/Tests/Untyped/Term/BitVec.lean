...
namespace Cvc.Proto.Tests.Untyped.Term.BitVec
...
#guard_msgs in #eval Env.runIO do
  ...
  let v ← Cvc.Proto.Untyped.Term.mkSymbolAs (BitVec 4) "v"
  let w ← Cvc.Proto.Untyped.Term.mkSymbolAs (BitVec 6) "w"
...
#guard_msgs in #eval Env.runIO do
  let u ← Cvc.Proto.Untyped.Term.mkSymbolAs (BitVec 4) "u"
  let v ← Cvc.Proto.Untyped.Term.mkSymbolAs (BitVec 4) "v"
  let c ← Cvc.Proto.Untyped.Term.mkSymbolAs (BitVec 1) "c"
...
-/
#guard_msgs in #eval Env.runIO do
  let u ← Cvc.Proto.Untyped.Term.mkSymbolAs (BitVec 8) "u"
...
#guard_msgs in #eval Env.runIO do
  ...
  let c ← Cvc.Proto.Untyped.Term.mkSymbolAs Bool "c"
