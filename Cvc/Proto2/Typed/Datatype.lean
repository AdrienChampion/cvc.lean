...
import all Cvc.Proto2.Untyped.Datatype

public import Cvc.Proto2.Untyped.Datatype
...
structure Ctor (α : Type) where
  private mk ::
  private ctor : Proto2.Datatype.Constructor
...
-/
def reflect (α : Type) [ToTyp α] : Env Proto2.Datatype := do
  let srt ← Srt.of α
