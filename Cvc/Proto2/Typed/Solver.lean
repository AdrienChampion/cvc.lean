...
import all Cvc.Proto2.Typed.Grammar

public import Cvc.Proto2.Untyped.Solver
public import Cvc.Proto2.Typed.Grammar
public import Cvc.Proto2.Typed.Term
public import Cvc.Proto2.Typed.BVar
...
-/
namespace Cvc.Proto2.Typed public section

/-- A solver instance. -/
abbrev Solver [Ω] := Cvc.Proto2.Untyped.Solver

/-- What a check-sat answered. -/
abbrev Result := Cvc.Proto2.Untyped.Solver.Result

export Cvc.Proto2.Untyped (EnvSatT EnvSat EnvUnsatT EnvUnsat EnvUnknownT EnvUnknown)

namespace Solver variable [Ω]

/-- Creates a new solver. -/
def new : Env Solver := Cvc.Proto2.Untyped.Solver.new

section variable [Ω] [Monad m] [MonadLiftT BaseIO m] (s : Solver)


open Cvc.Proto2 renaming Untyped.Solver → U
...
`mkGrammar` is here rather than in `Cvc/Proto2/Typed/Grammar.lean` because it needs a solver, and
...
@[inherit_doc U.checkSatResult]
def checkIsSat? : Env Cvc.Proto2.Untyped.Solver.Result.Sat? := U.checkIsSat? s assuming
