...
import Cvc.Proto2.Untyped.BVar
import Cvc.Proto2.Untyped.Term
import Cvc.Proto2.Untyped.Solver

public meta import Cvc.Proto2.Untyped.BVar
...
-/
namespace Cvc.Proto2.Tests.Untyped.BVar
...
#guard_msgs in #eval Env.runIO do
  ...
  println! "BVar.mk: {(← Cvc.Proto2.Untyped.BVar.mk int "w").toTerm}"
...
#guard_msgs in #check @Cvc.Proto2.Untyped.Term.mkBVar
