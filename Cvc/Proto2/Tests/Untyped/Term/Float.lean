...
import Cvc.Proto2.Untyped.Term.Float
import Cvc.Proto2.Untyped.Term.Bool
import Cvc.Proto2.Untyped.Term.BitVec
import Cvc.Proto2.Types.Float

public meta import Cvc.Proto2.Untyped.Term.Float
public meta import Cvc.Proto2.Untyped.Term.Bool
public meta import Cvc.Proto2.Untyped.Term.BitVec
public meta import Cvc.Proto2.Types.Float



/-! # Generated Float constructors, sort-erased -/
namespace Cvc.Proto2.Tests.Untyped.Term.Float
...
#guard_msgs in #eval Env.runIO do
  let f ← Cvc.Proto2.Untyped.Term.mkSymbolAs (Cvc.Proto2.Float 8 24) "f"
  let g ← Cvc.Proto2.Untyped.Term.mkSymbolAs (Cvc.Proto2.Float 8 24) "g"
...
#guard_msgs in #eval Env.runIO do
  let f ← Cvc.Proto2.Untyped.Term.mkSymbolAs (Cvc.Proto2.Float 8 24) "f"
  let g ← Cvc.Proto2.Untyped.Term.mkSymbolAs (Cvc.Proto2.Float 8 24) "g"
  let rm ← Cvc.Proto2.Untyped.Term.mkRoundingMode .nearestTiesToEven
  let sgn ← Cvc.Proto2.Untyped.Term.mkSymbolAs (BitVec 1) "sgn"
  let ex ← Cvc.Proto2.Untyped.Term.mkSymbolAs (BitVec 8) "ex"
  let sig ← Cvc.Proto2.Untyped.Term.mkSymbolAs (BitVec 23) "sig"
...
#guard_msgs in #eval Env.runIO do
  ...
  let rm ← Cvc.Proto2.Untyped.Term.mkRoundingMode .nearestTiesToEven
  let w ← Cvc.Proto2.Untyped.Term.mkSymbolAs (BitVec 32) "w"
