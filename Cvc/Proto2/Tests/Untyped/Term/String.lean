...
import Cvc.Proto2.Untyped.Term.String
import Cvc.Proto2.Untyped.Term.Bool

public meta import Cvc.Proto2.Untyped.Term.String
public meta import Cvc.Proto2.Untyped.Term.Bool



/-! # Generated String constructors, sort-erased -/
namespace Cvc.Proto2.Tests.Untyped.Term.String
...
#guard_msgs in #eval Env.runIO do
  let s ← Cvc.Proto2.Untyped.Term.mkSymbolAs (String) "s"
  let t ← Cvc.Proto2.Untyped.Term.mkSymbolAs (String) "t"
  let re ← Cvc.Proto2.Untyped.Term.mkSymbolAs (Cvc.Proto2.Regex) "re"
