...
import Cvc.Proto2.Typed.Synth
import Cvc.Proto2.Typed.Term

public meta import Cvc.Proto2.Typed.Synth
public meta import Cvc.Proto2.Typed.Term



/-! # Syntax-guided synthesis, typed -/
namespace Cvc.Proto2.Tests.Typed.Synth
...
#guard_msgs in #check @Cvc.Proto2.Typed.Solver.synthFun

/-- info: @Solver.getSynthSolution : [inst : Ω] → Solver → {σ : Type} → Term σ → EnvSolved (Term σ) -/
#guard_msgs in #check @Cvc.Proto2.Typed.Solver.getSynthSolution
...
#guard_msgs in #check @Cvc.Proto2.Typed.Solver.addSygusConstraint
