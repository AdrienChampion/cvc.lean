...
import Cvc.Proto2.Typed.Term.Seq
import Cvc.Proto2.Typed.Term.Bool

public meta import Cvc.Proto2.Typed.Term.Seq
public meta import Cvc.Proto2.Typed.Term.Bool



/-! # Generated Seq constructors, typed -/
namespace Cvc.Proto2.Tests.Typed.Term.Seq
...
#guard_msgs in #eval Env.runIO do
  println! "mkEmptySeq : {← (mkEmptySeq : Env (Cvc.Proto2.Typed.Term (Array Int)))}"
