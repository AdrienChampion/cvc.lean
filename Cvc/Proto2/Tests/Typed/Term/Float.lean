...
import Cvc.Proto2.Typed.Term.Float
import Cvc.Proto2.Typed.Term.Bool
import Cvc.Proto2.Typed.Term.BitVec

public meta import Cvc.Proto2.Typed.Term.Float
public meta import Cvc.Proto2.Typed.Term.Bool
public meta import Cvc.Proto2.Typed.Term.BitVec



/-! # Generated Float constructors, typed -/
namespace Cvc.Proto2.Tests.Typed.Term.Float
...
#guard_msgs in #eval Env.runIO do
  let f ← Cvc.Proto2.Typed.Term.mkSymbolAs (Cvc.Proto2.Float 8 24) "f"
  let g ← Cvc.Proto2.Typed.Term.mkSymbolAs (Cvc.Proto2.Float 8 24) "g"
...
#guard_msgs in #eval Env.runIO do
  let f ← Cvc.Proto2.Typed.Term.mkSymbolAs (Cvc.Proto2.Float 8 24) "f"
  let g ← Cvc.Proto2.Typed.Term.mkSymbolAs (Cvc.Proto2.Float 8 24) "g"
  let rm ← Cvc.Proto2.Typed.Term.mkRoundingMode .nearestTiesToEven
  let sgn ← Cvc.Proto2.Typed.Term.mkSymbolAs (BitVec 1) "sgn"
  let ex ← Cvc.Proto2.Typed.Term.mkSymbolAs (BitVec 8) "ex"
  let sig ← Cvc.Proto2.Typed.Term.mkSymbolAs (BitVec 23) "sig"
...
#guard_msgs in #eval Env.runIO do
  ...
  let rm ← Cvc.Proto2.Typed.Term.mkRoundingMode .nearestTiesToEven
  let w ← Cvc.Proto2.Typed.Term.mkSymbolAs (BitVec 32) "w"
  let u ← Cvc.Proto2.Typed.Term.mkSymbolAs (BitVec 4) "u"
