...
import Cvc.Proto2.Typed.Term.Set
import Cvc.Proto2.Typed.Term.Bool

public meta import Cvc.Proto2.Typed.Term.Set
public meta import Cvc.Proto2.Typed.Term.Bool



/-! # Generated Set constructors, typed -/
namespace Cvc.Proto2.Tests.Typed.Term.Set
...
-/
#guard_msgs in #eval Env.runIO do
  println! "empty    : {← (setEmpty : Env (Cvc.Proto2.Typed.Term (Cvc.Proto2.Set Int)))}"
  println! "universe : {← (setUniverse : Env (Cvc.Proto2.Typed.Term (Cvc.Proto2.Set Int)))}"
