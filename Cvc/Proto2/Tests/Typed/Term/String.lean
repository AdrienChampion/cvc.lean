...
import Cvc.Proto2.Typed.Term.String
import Cvc.Proto2.Typed.Term.Bool

public meta import Cvc.Proto2.Typed.Term.String
public meta import Cvc.Proto2.Typed.Term.Bool



/-! # Generated String constructors, typed -/
namespace Cvc.Proto2.Tests.Typed.Term.String
...
#guard_msgs in #eval Env.runIO do
  let s ← Cvc.Proto2.Typed.Term.mkSymbolAs (String) "s"
  let t ← Cvc.Proto2.Typed.Term.mkSymbolAs (String) "t"
  let re ← Cvc.Proto2.Typed.Term.mkSymbolAs (Cvc.Proto2.Regex) "re"
