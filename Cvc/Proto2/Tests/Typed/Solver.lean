...
-/
namespace Cvc.Proto2.Tests.Typed.Solver
...
#guard_msgs in #check @Cvc.Proto2.Typed.Solver.assert

/-- info: @Untyped.Solver.assert : [inst : Ω] → Untyped.Solver → Untyped.Term → Env Unit -/
#guard_msgs in #check @Cvc.Proto2.Untyped.Solver.assert

/-- info: @Solver.getUnsatCore : [inst : Ω] → Solver → EnvUnsat (Terms Bool) -/
#guard_msgs in #check @Cvc.Proto2.Typed.Solver.getUnsatCore
