...
-/
namespace Cvc.Proto2.Tests.Signatures
...
#guard_msgs in #check @Cvc.Proto2.Typed.Term.equal
...
#guard_msgs in #check @Cvc.Proto2.Typed.Term.equalN
...
#guard_msgs in #check @Cvc.Proto2.Typed.Term.neg
...
#guard_msgs in #check @Cvc.Proto2.Typed.Term.bvConcat

/-- info: @Typed.Term.bvUlt : [inst : Ω] → {n : Nat} → Typed.Term (BitVec n) → Typed.Term (BitVec n) → Env (Typed.Term Bool) -/
#guard_msgs in #check @Cvc.Proto2.Typed.Term.bvUlt
...
#guard_msgs in #check @Cvc.Proto2.Typed.Term.select
...
#guard_msgs in #check @Cvc.Proto2.Typed.Term.setMember
...
#guard_msgs in #check @Cvc.Proto2.Typed.Term.seqNth
...
#guard_msgs in #check @Cvc.Proto2.Typed.Term.fpIsNan
...
#guard_msgs in #check @Cvc.Proto2.Typed.Term.bvIte
...
#guard_msgs in #check @Cvc.Proto2.Typed.Term.bagPartition
...
#guard_msgs in #check @Cvc.Proto2.Typed.Term.bvFromBool
...
#guard_msgs in #check @Cvc.Proto2.Typed.Term.bvFromBools
...
: Env (Term (Cvc.Proto2.Float 8 24)) := fpOfBits sgn ex sig
