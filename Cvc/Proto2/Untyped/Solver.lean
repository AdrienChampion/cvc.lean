...
public import Cvc.Proto2.Untyped.Mode
...
-/
namespace Cvc.Proto2.Untyped public section
...
`env_gen%` comes from `Cvc/Proto2/Untyped/Mode.lean`; the private lift it generates is private to
